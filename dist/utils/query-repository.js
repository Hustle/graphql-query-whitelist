...
var QueryRepository = function () {
  ...
  (0, _createClass3.default)(QueryRepository, [{
    ...
    key: 'update',
    value: function () {
      var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(queryId) {
        ...
        return _regenerator2.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 7:
                return _context3.abrupt('return', (0, _extends3.default)({ id: queryId }, query));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                return _context4.abrupt('return', entries.map(function (_ref5) {
    ...
    key: 'delete',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(queryId) {
        return _regenerator2.default.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                return _context5.abrupt('return', this.store.delete(queryId));
